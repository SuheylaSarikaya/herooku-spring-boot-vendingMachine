...
public class TestUpdateCountProduct {
    ...
    public void perform() {
        ...
        vendingMachineService.updateCountProduct(productDTO);
        Assert.assertEquals(30,product.get().getCount());
    }
}
