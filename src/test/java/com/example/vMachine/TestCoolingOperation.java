...
public class TestCoolingOperation {
    ...
    public void perform() {
        ...
        vendingMachineService.performCoolingOperation();
        Assert.assertEquals(20,product.get().getTemperature());
    }
}
